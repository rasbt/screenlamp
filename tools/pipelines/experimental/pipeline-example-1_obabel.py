...
OBABEL_EXECUTABLE = ymldct['OpenBabel Confab settings']['OpenBabel executable']
...
################################################
    ...
    cmd = ['python', os.path.join(SCREENLAMP_TOOLS_DIR, 'generate_conformers_obabel.py'),
           '--input', os.path.join(PROJECT_PATH,
                                   '03_fgroup_distance_mol2s'),
           '--output', os.path.join(PROJECT_PATH, '04_obabel_conformers'),
           '--executable', OBABEL_EXECUTABLE]
    ...
    cmd = ['python', os.path.join(SCREENLAMP_TOOLS_DIR, 'count_mol2.py'),
           '--input', os.path.join(PROJECT_PATH, '04_obabel_conformers')]
